...
describe("database schema exports", () => {
  it("exports donationsTable with expected columns", () => {
    ...
    expect(
      (donationsTable as unknown as Record<string, unknown>).donations,
    ).toBeUndefined();
    expect(
      (donationsTable as unknown as Record<string, unknown>).gender,
    ).toBeDefined();
    expect(
      (donationsTable as unknown as Record<string, unknown>).email,
    ).toBeDefined();
  });
  ...
  it("exports newsletterTable with expected columns", () => {
    ...
    expect(
      (newsletterTable as unknown as Record<string, unknown>).email,
    ).toBeDefined();
  });
});
