  ...
  de: {
    ...
    homepage: {
      emailCommunication: {
        ...
        description:
          "Vor nunmehr 30 Jahren begann der Siegeszug der Email. Seitdem hat die Email-Kommunikation mehr und mehr Briefe ersetzt. Sprachlich unterscheiden sich Emails und Briefe in vielen Aspekten.",
      },
      dataSpende: {
        title: "Datenspende",
        description:
          "Um Emails zu analysieren, benötigen wir Emails als Korpus. Wir sind auf Ihre Email-Spenden angewiesen. Leisten Sie einen wertvollen Beitrag zur Forschung und helfen Sie, Email-Kommunikation besser zu verstehen!",
      },
      tutorial: {
        title: "Tutorial",
        description:
          "Lernen Sie, wie Sie an unserem Email-Forschungsprojekt teilnehmen können.",
      },
      blog: {
        title: "Blog",
    ...
    about: {
      ...
      projectDescription:
        "Auch wenn die E-Mail nun schon seit Jahrzehnten als persönliches oder auch als professionelles Kommunikationsmittel benutzt wird, gibt es nur relativ wenige linguistische Arbeiten, die ihren Sprachgebrauch genauer analysieren. Ein wesentlicher Grund für die überschaubare Anzahl an umfassenden linguistischen Studien, liegt in der mangelnden Datenbasis. Um E-Mails analysieren zu können, benötigen wir E-Mails als Korpora. Anders als bei Briefen, von denen ein Teil bis heute in sehr verschiedenen kleinen oder großen Archiven aufbewahrt und dort zur Analyse genutzt werden können, haben wir für E-Mails keine Datenbanken, die uns ausreichend E-Mails zur Analyse zur Verfügung stellen könnten. Wir sind demzufolge auf E-Mail-Spenden angewiesen.",
      dataHandling:
        "Mit den gespendeten E-Mails, die selbstverständlich von uns komplett pseudonymisiert werden, hätten wir die Möglichkeit, verschiedene linguistische Fragestellungen zu bearbeiten oder auch die Frage zu beantworten, ob und warum wir E-Mails anders schreiben als Briefe.",
      dataHandlingTitle: "Umgang mit den Daten/Pseudonymisierung",
      donorNote:
        "Hinweise an die Spendenden: Bitte spenden Sie ausschließlich E-Mails, die Sie selbst gesendet haben oder bei denen Sie die Zustimmung aller Beteiligten eingeholt haben.",
      pseudonymizationTitle: "Pseudonymisierung der Mails",
      pseudonymizationText:
        "Die E-Mails werden automatisch pseudonymisiert. Dazu nutzen wir ein entsprechendes Tool, welches wir im vergangenen Jahr an hunderten Test-E-Mails überprüft haben. Durch die Pseudonymisierung werden alle persönlichen Daten wie Namen, Telefonnummer oder Adressen aus dem E-Mails herausgestrichen und durch Platzhalter wie Name für Sabine Mustermann ersetzt.",
      numberAndTypeTitle: "Anzahl und Art der E-Mails",
      numberAndTypeText:
        "Es gibt keine Begrenzung. Sie können grundsätzlich so viele E-Mails spenden wie Sie möchten. Die E-Mails können gerne zu den unterschiedlichsten Anlässen und in unterschiedlichsten Situationen geschrieben worden sein.",
    ...
    donation: {
      ...
      modals: {
        formModal: {
          ...
          nativeLanguage:
            "Ist die Sprache, in der Sie schreiben, Ihre Muttersprache?",
        ...
        forwardEmailModal: {
          ...
          revocationText:
            "Falls Sie Ihre Spende zu einem späteren Zeitpunkt widerrufen möchten, nutzen Sie bitte die ID, die Sie in der Bestätigungsemail erhalten haben.",
          forwardingText:
            "Um Ihre Emails zu spenden, leiten Sie diese bitte an folgende Adresse weiter:",
        ...
        disclosureModal: {
          ...
          header:
            'Information und Einwilligungserklärung zum wissenschaftlichen Forschungsvorhaben "Schreiben nach der Briefkultur: MailCom"',
          informationTitle:
          ...
          costsText:
            "Durch die Teilnahme an diesem wissenschaftlichen Forschungsvorhaben entstehen für Sie keine Kosten. Eine Aufwandsentschädigung für Ihre Teilnahme an dem wissenschaftlichen Forschungsvorhaben wird nicht gezahlt. Ansprüche auf andere Formen der Vergütung, Tantiemen oder sonstige Beteiligungen an finanziellen Vorteilen und Gewinnen, die möglicherweise auf der Basis der Forschungsergebnisse erzielt werden, sind ausgeschlossen.",
          withdrawalTitle:
            "Wer entscheidet, ob ich aus dem wissenschaftlichen Forschungsvorhaben gegebenenfalls vorzeitig ausscheide?",
          withdrawalText:
            "Die Teilnahme an diesem wissenschaftlichen Forschungsvorhaben ist freiwillig. Sie können jederzeit ohne Angabe von Gründen die Löschung Ihrer gespendeten E-Mails verlangen, ohne dass Ihnen dadurch Nachteile entstehen. Um die Löschung zu vollziehen, senden Sie uns den Pin-Code, den Sie am Ende Ihrer Spende erhalten haben in einer formlosen E-Mail an mailcom@rose.uni-heidelberg.de.",
          revocationTitle: "Widerrufsbelehrung",
          revocationText:
            "Sie können Ihre Einwilligung zur Datenspende jederzeit widerrufen. Ab dem Moment des Widerrufs verwenden wir Ihre Daten nicht mehr weiter. Um Ihr Widerrufsrecht in Anspruch zu nehmen, senden Sie uns eine E-Mail mit Ihrer Identifikationsnummer (diese erhalten Sie bei der Datenspende per E-Mail) und teilen Sie uns formlos, aber eindeutig mit, dass Sie widerrufen möchten. Ihre Daten werden ab dem Zeitpunkt Ihres Widerrufs nicht mehr für wissenschaftliche Zwecke oder Veröffentlichungen verwendet.",
          ...
          dataCollectionItems: {
            emails:
              "Die von Ihnen durch das Weiterleiten an die Spende-Adresse übermittelten E-Mails",
            questionnaire:
              "Fragebogendaten zu Ihrer Person (Alter, Geschlecht, sprach-geographische Daten (Region der Abfassung der E-Mails))",
          },
          dataCollectionNote:
          ...
          rightsContact:
            "Ihre Rechte sind grundsätzlich schriftlich bei dem zur Datenverarbeitung Verantwortlichen geltend zu machen. Richten Sie Ihren Widerruf bitte an die folgende E-Mail-Adresse: mailcom@rose.uni-heidelberg.de.",
          responsibilityTitle:
          ...
          checkboxText:
            "Ich habe die Informationen zum Datenschutz und Widerruf gelesen und stimme der Aufzeichnung und Verarbeitung meiner Daten zu.",
          buttons: {
        ...
        alerts: {
          confirmRequired:
            "Bitte bestätigen Sie die Einwilligungserklärung um fortzufahren.",
          rejected:
            "Sie haben die Einwilligungserklärung abgelehnt. Ihre Daten werden nicht gespeichert.",
          successMessage:
            "Ihre Spende wurde erfasst. Eine Bestätigungsemail mit Ihrer Spenden-ID wurde an Ihre Email-Adresse gesendet.",
          errorMessage:
            "Bei der Erfassung Ihrer Spende ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.",
          sendFailedMessage:
            "Ihre Spende wurde mit der ID {id} erfasst, aber die Bestätigungsemail konnte nicht gesendet werden. Bitte notieren Sie diese ID.",
    ...
    tutorial: {
      title: "Tutorial",
      description:
        "Lernen Sie Schritt für Schritt, wie Sie an unserem Email-Forschungsprojekt teilnehmen können.",
    ...
    blog: {
      title: "Blog",
      description:
        "Hier finden Sie aktuelle Neuigkeiten und Erkenntnisse aus unserem Email-Forschungsprojekt.",
    },
    contact: {
      title: "Kontakt",
      description:
        "Nehmen Sie Kontakt mit unserem Forschungsteam unter mailcom@rose.uni-heidelberg.de auf. Wir freuen uns auf Ihre Fragen und Anregungen.",
      form: {
        name: "Name",
    ...
    team: {
      ...
      phDStudent1Description:
        "Für ihre Promotion arbeitet Laura Gärtner mit einer Sammlung von Daten aus sozialen Medien, Webseiten und Printmedien, die sie mittels computergestützter Textanalyse und NLP-Verfahren auswertet. Im Mailcom-Projekt vermittelt sie zwischen informatischen Methoden und sprachwissenschaftliche Fragestellungen.",
      ...
      rSETeam:
        "Kooperation mit dem Scientific Software Center der Universität Heidelberg",
      rSETeam1: "Dr. Inga Ulusoy",
      rSETeam2: "Dr. Kim Tuyen Le",
      rSELinkText: "Scientific Software Center",
      fundingInfo:
        "Unterstützt durch das Field of Focus 3 und das HCDH (Förderungsperiode 2024/2025).",
      publications: "Publikationen",
      publication1:
        "Bothe, Laura/Große, Sybille (2023): „Datensammlung in der Romanistik – Eine Analyse von Normierung und Standardisierung in E-Mails“, in: Vincent Heuveline, Nina Bisheh und Philipp Kling (Hg.): E-Science-Tage 2023. Empower Your Research – Preserve Your Data. Heidelberg: heiBOOKS, 132-139.",
      publication2:
        'Le, Kim Tuyen/Gärtner, Laura/Fleischle, Felix/Schoeller, Thore/Große, Sybille/Ulusoy, Inga (2026): "mailcom: Pseudonymization Tool for Textual Data", submitted to SoftwareX.',
      dOIText: "DOI",
    },
    faq: {
      ...
      questions: {
        ...
        q7: {
          ...
          answer:
            "Das Projekt ist ein linguistisches Projekt an der Universität Heidelberg. Nur von der Projektleitung autorisierte Personen dürfen am Forschungsprojekt teilnehmen. Für mehr Informationen zum Team, ",
          linkText: "klicken Sie hier.",
        },
        q8: {
          question: "Wie wird mit den Daten gearbeitet?",
          answer:
            "Die E-Mails werden von uns ausschließlich in pseudonymisierter Form gespeichert und danach analysiert. In der Analyse haben wir keinen Zugriff auf Daten, d.h. auf E-Mails, die nicht pseudonymisiert sind. Die Daten werden ausschließlich für wissenschaftliche Zwecke genutzt.",
        },
        q9: {
          question: "Wie werden die E-Mails pseudonymisiert?",
          answer1:
            "Die E-Mails werden zunächst automatisch pseudonymisiert. Dazu nutzen wir ein entsprechendes",
          answer2:
            "welches wir im vergangenen Jahr an hunderten Test-E-Mails überprüft haben. Durch die Pseudonymisierung werden alle persönlichen Daten wie Namen, Telefonnummer oder Adressen aus den E-Mails herausgestrichen und durch Platzhalter wie Name für Sabine Mustermann ersetzt. Im Anschluss werden die pseudonymisierten E-Mails noch einmal von geschulten studentischen Hilfskräften des Projektes durchsucht und gegebenenfalls komplett pseudonymisiert, so dass nur vollständig pseudonymisierte E-Mails von uns in die Analysen einbezogen werden.",
          linkText: "Tool (mailcom),",
        },
        q10: {
          question: "Wo werden meine E-Mails gespeichert?",
          answer:
            "Die pseudonymisierten E-Mails werden auf einem passwortgeschützten Server der Universität Heidelberg zwischengespeichert. Eine längerfristige Speicherung erfolgt nur von diesen vollständig pseudonymisierten E-Mails.",
        },
        q11: {
          question: "Wer kann meine E-Mails einsehen?",
          answer:
            "Die von Ihnen gespendeten E-Mails sind vor unbefugtem Zugriff geschützt. Die Pseudonymisierung stellt sicher, dass keine persönlichen Daten identifizierbar bleiben. Nach der Pseudonymisierung werden die E-Mails in einer Datenbank abgelegt, die für Forschungszwecke genutzt wird. Dort werden die E-Mails anhand spezifischer Suchanfragen analysiert, welche sich - je nach der gewählten Forschungsfrage - unterscheiden können. Der Zugang zu den pseudonymisierten E-Mails ist streng limitiert. Nur von der Projektleitung autorisierte Personen dürfen auf die E-Mails zugreifen. Dazu gehören:",
          listItems: [
            "Postdoktorand*innen,",
            "Doktorand*innen,",
            "ausgewählte studentische Hilfskräfte, die im Projekt mitarbeiten.",
          ],
          afterList:
            "So wird sichergestellt, dass Ihre Daten ausschließlich im Rahmen des Forschungsprojekts und durch qualifizierte Fachkräfte verarbeitet werden.",
        },
        q12: {
          question: "Wie / Wo werden die Daten gegebenenfalls veröffentlicht?",
          answer1:
            "Die E-Mails werden von uns wissenschaftlich ausgewertet. Die daraus entstehenden Forschungsergebnisse werden in Fachpublikationen veröffentlicht. In diesen werden in Auszügen Einzelbeispiele aus dem E-Mail-Korpus zur Illustration wissenschaftlicher Aussagen in pseudonymisierter Form veröffentlicht. Falls Sie mehr über unsere Forschungsergebnisse wissen möchten, können Sie sich hier zu unserem",
          linkText: "Newsletter",
          answer2: "anmelden.",
        },
        q13: {
          ...
          answer:
            'Folgen Sie der Anleitung unter "Datenspende". Sie werden in der Datenspende darum gebeten, die Emails die Sie spenden möchten, an eine Spender-Adresse weiterzuleiten. Weiterhin werden einige wenige Metadaten abgefragt, die für die Forschungsarbeiten wichtig sind. Sowohl die Metadaten als auch die gespendeten Emails können nach erfolgter Pseudonymisierung nicht mehr einer Person zugeordnet werden und enthalten keine persönliche Daten.',
        },
        q14: {
          question: "Was muss ich beim Spenden meiner Emails beachten?",
          answer:
            "Sie werden in der Datenspende darum gebeten, die Emails die Sie spenden möchten, an eine Spender-Adresse weiterzuleiten. Bitte leiten Sie keine zu großen Anhänge weiter (>10 MB).",
        },
        q15: {
          question:
  ...
  fr: {
    ...
    homepage: {
      emailCommunication: {
        ...
        description:
          "C'est il y a environ trente ans que le triomphe de l'e-mail a commencé. Depuis lors, la communication par mail a peu à peu remplacé les lettres. D'un point de vue linguistique, les e-mails et les lettres sont différents à bien des égards.",
      },
      dataSpende: {
        title: "Don de données",
        description:
          "Pour analyser les mails, nous avons besoin d'un corpus. Nous comptons sur vos dons d'e-mails. Apportez une contribution précieuse à la recherche et aidez-nous à mieux comprendre la communication par mail !",
      },
      tutorial: {
        title: "Tutoriel",
        description:
          "Comment participer à notre projet de recherche sur les e-mails ?",
      },
      blog: {
        title: "Blog",
        description:
          "Dernières mises à jour de notre recherche et découvertes.",
      },
    },
    about: {
      title: "Description du projet",
      projectDescription:
        "Même si l'e-mail est utilisé, maintenant depuis des décennies, comme un moyen de communication dans les échanges personnels comme professionnels, il n'existe que relativement peu de travaux linguistiques analysant précisément son usage de la langue. L'une des raisons principales à ce faible nombre d'études linguistiques approfondies tient au manque de données. Pour pouvoir analyser des e-mails, nous avons besoin d'un corpus. Contrairement aux lettres dont une partie a été conservée jusqu'à aujourd'hui dans des archives très diverses, plus ou moins grandes, où elles peuvent être utilisées pour l'analyse, nous ne disposons pas de base de données, pour les e-mails, pouvant nous fournir suffisamment de matière à analyser. Nous dépendons donc des dons d'e-mails.",
      dataHandling:
        "Avec les e-mails donnés que nous rendrons bien-sûr complètement anonymes, nous aurions la possibilité de traiter différents sujets linguistiques ou de répondre à la question de savoir si et pourquoi nous écrivons par mail différemment que par voie épistolaire.",
      dataHandlingTitle: "Traitement des données/anonymisation",
      donorNote:
        " Remarque à l'attention des donateur·rice·s : Merci de ne donner que des e-mails que vous avez vous-même envoyés ou pour lesquels vous avez obtenu l'accord de toutes les personnes impliquées dans l'échange.",
      pseudonymizationTitle: "Anonymisation des e-mails",
      pseudonymizationText:
        "Les e-mails sont anonymisés automatiquement. Nous utilisons pour cela un outil dont nous avons vérifié l'efficacité l'année dernière, sur des centaines d'e-mails tests. Grâce à l'anonymisation, toutes les données personnelles telles que les noms, les numéros de téléphone ou les adresses sont supprimées des e-mails et remplacées par des caractères de substitution – l'emplacement du nom sera par exemple remplacé par Jean Dupont.",
      numberAndTypeTitle: "Nombre et type d'e-mails",
      numberAndTypeText:
        "Il n'y a pas de limite au nombre d'e-mails que vous donnez. Vous pouvez en principe en donner autant que vous le souhaitez. Nous collectons volontiers les e-mails écrits lors d'occasions diverses et variées.",
    ...
    donation: {
      ...
      modals: {
        formModal: {
          ...
          nativeLanguage:
            "La langue dans laquelle vous écrivez est-elle votre langue maternelle ?",
          nativeLanguageOptions: {
            yes: "Oui",
            no: "Non",
            noAnswer: "Aucune indication",
        ...
        forwardEmailModal: {
          title: "Métadonnées",
          emailLabel:
            "Votre adresse e-mail depuis laquelle vous faites un don :",
          revocationText:
            "Si vous souhaitez révoquer votre don à un moment ultérieur, veuillez utiliser l'ID que vous avez reçue dans l'e-mail de confirmation.",
          forwardingText:
            "Pour faire un don de vos e-mails, veuillez les transférer à l'adresse suivante :",
          donationEmail: "mailcom-donation@rose.uni-heidelberg.de",
          buttons: {
            submit: "Soumettre",
            next: "Suivant",
        ...
        disclosureModal: {
          ...
          header:
            "Informations et déclaration de consentement relatives au projet de recherche scientifique Écrire après la culture épistolaire – MailCom –",
          informationTitle:
            "Informations sur le projet de recherche scientifique",
          informationText:
          ...
          costsTitle:
            "Des coûts vont-ils m'être facturés pour participer à ce projet de recherche scientifique et une indemnisation de frais sera-t-elle versée ?",
          costsText:
          ...
          withdrawalTitle:
            "Qui est-ce qui décide si je dois quitter prématurément le projet de recherche scientifique ?",
          withdrawalText:
          ...
          dataProtectionHeader:
            "Information sur la protection des données : Que deviennent mes données ?",
          dataCollectionTitle:
            "Quelles sont les données qui seront collectées dans le cadre du projet de recherche scientifique ?",
          dataCollectionIntro:
            "Dans le cadre du projet de recherche scientifique, les données suivantes seront collectées :",
          dataCollectionItems: {
            emails:
              "Les e-mails que vous nous transmettez en les transférant à l'adresse de don",
            questionnaire:
              "Les données du questionnaire concernant votre personne (âge, sexe, données géolinguistiques (par exemple, la région dans laquelle les e-mails ont été rédigés))",
          },
          dataCollectionNote:
            "Les données du projet peuvent également inclure des catégories particulières de données personnelles, telles que des données personnelles qui révèlent des opinions politiques, des convictions religieuses ou philosophiques ou l'appartenance à un syndicat, des données sur la vie sexuelle ou sur l'orientation sexuelle.",
          dataProcessingTitle:
            "De quelle manière les données sont-elles traitées dans le cadre du projet de recherche scientifique ?",
          dataProcessingText:
            "Les données produites par le projet, c'est-à-dire les e-mails et les réponses au bref questionnaire, sont automatiquement anonymisées. Toutes les informations qui pourraient conduire à l'identification de votre personne (par exemple le nom, l'adresse e-mail, les noms de lieux, les numéros de téléphone, les noms d'associations et d'organisations) et toutes autres indications sont modifiées et ainsi rendues non reconnaissables. L'évaluation des données par les membres du projet n'a lieu qu'après l'anonymisation des données. Dans certains cas, d'autres passages de texte peuvent être supprimés ou partiellement déformés par des membres de notre projet pour garantir l'anonymat complet des auteur·rice·s. Dans les publications scientifiques, dans les conférences et les colloques, aucune donnée personnelle vous concernant ne sera mentionnée, c'est-à-dire que les résultats de la recherche seront publiés sans référence à votre personne. Les e-mails anonymisés ne seront pas cités en entier, seulement en extraits pour garantir qu'aucun tiers ne pourra, d'après le contexte global des événements, identifier votre personne.",
          dataAccessTitle:
            "Qui a connaissance des données et quelles personnes et institutions y ont accès ?",
          dataAccessText:
            "Seuls les membres du projet de recherche scientifique ont accès à vos e-mails et aux données. Ces personnes sont tenues de respecter les exigences en matière de protection des données. Les données sont protégées contre tout accès non autorisé.",
          rightsTitle:
            "Quels sont les droits des personnes concernées par le traitement des données ?",
          rightsIntro:
            "La participation au projet de recherche scientifique se fait sur la base du volontariat ; si vous ne participez pas, vous ne subirez aucun préjudice. Vous avez à tout moment la possibilité d'exercer les droits suivants :",
          rightsItems: {
            information:
              "Droit d'accès aux données personnelles vous concernant (art. 15 RGPD)",
            correction:
              "Droit de rectification des données personnelles inexactes vous concernant (art. 16 RGPD)",
            deletion:
              "Droit d'effacement des données personnelles vous concernant (art. 17 RGPD)",
            restriction:
              "Droit de limitation du traitement des données personnelles vous concernant (art. 18 RGPD)",
            objection:
              "Droit d'opposition au traitement des données personnelles vous concernant (art. 21 RGPD)",
            complaint:
              "Vous avez également le droit de vous plaindre auprès d'une autorité de contrôle de la protection des données du traitement de vos données personnelles par nos soins (art. 77 RGPD)",
            revocation:
              "Dans la mesure où vous avez consenti au traitement de vos données, vous avez la possibilité de révoquer ce consentement pour l'avenir à tout moment (art. 7, par. 3 RGPD). Dans ce cas, toutes les données personnelles devront être supprimées ou anonymisées.",
          },
          rightsContact:
            "Vos droits doivent en principe être exercés par écrit auprès du responsable du traitement des données. Veuillez adresser votre révocation à l'adresse e-mail suivante : mailcom@rose.uni-heidelberg.de.",
          responsibilityTitle:
            "Qui est-ce qui est responsable du projet de recherche scientifique et du traitement des données qui en découlent ? À qui puis-je m'adresser pour obtenir des informations supplémentaires ?",
          responsibilityText:
          ...
          checkboxText:
            "J'ai lu les informations sur la protection des données et j'accepte le traitement de mes données.",
          buttons: {
        ...
        alerts: {
          confirmRequired:
            "Veuillez confirmer la déclaration de consentement pour continuer.",
          rejected:
            "Vous avez refusé la déclaration de consentement. Vos données ne seront pas enregistrées.",
          successMessage:
            "Votre don a été enregistré. Un e-mail de confirmation contenant votre identifiant de don a été envoyé à votre adresse e-mail.",
          errorMessage:
            "Une erreur est survenue lors de l'enregistrement de votre don. Veuillez réessayer.",
          sendFailedMessage:
            "Votre don a été enregistré avec l'identifiant {id}, mais l'e-mail de confirmation n'a pas pu être envoyé. Veuillez noter cet identifiant.",
    ...
    tutorial: {
      title: "Tutoriel",
      description:
        "Apprenez pas à pas comment participer à notre projet de recherche sur les e-mails.",
    ...
    blog: {
      title: "Blog",
      description:
        "Ici, vous trouverez les dernières actualités de notre projet de recherche sur les e-mails ainsi que nos découvertes.",
    },
    contact: {
      title: "Contact",
      description:
        "Contactez notre équipe de recherche sous mailcom@rose.uni-heidelberg.de. Nous nous réjouissons de recevoir vos questions et suggestions.",
      form: {
        name: "Nom",
    ...
    faq: {
      ...
      questions: {
        ...
        q7: {
          question:
            "Qui est-ce qui travaille dans ce projet de recherche sur les e-mails ?",
          answer:
            "Ce projet de linguistique est mené par une équipe de l'Université de Heidelberg. Seules les personnes autorisées par la direction du projet peuvent y participer. Pour plus d'informations sur l'équipe,",
          linkText: "cliquez ici.",
        },
        q8: {
          question: "Comment les données sont-elles traitées ?",
          answer:
            "Nous enregistrons les e-mails directement et uniquement sous forme anonymisée et les analysons ensuite. Lors de l'analyse, nous n'avons donc pas accès aux données, c'est-à-dire aux e-mails non anonymisés. Les données sont exclusivement utilisées à des fins scientifiques.",
        },
        q9: {
          question: "Comment les e-mails sont-ils anonymisés ?",
          answer1:
            "Les e-mails sont anonymisés automatiquement. Nous utilisons pour cela un",
          answer2:
            "dont nous avons vérifié l'efficacité l'année dernière sur des centaines de mails tests. Grâce à l'anonymisation, toutes les données personnelles telles que le nom, le numéro de téléphone ou l'adresse sont supprimées des e-mails et remplacées par des caractères de substitution – l'emplacement du nom sera par exemple remplacé par Jean Dupont. Ensuite, ces e-mails anonymisés automatiquement sont à nouveau examinés par des étudiant·e·s assistant·e·s formé·e·s au projet. Cela garantit que seuls les e-mails entièrement anonymisés seront pris en compte dans nos analyses.",
          linkText: "outil (mailcom)",
        },
        q10: {
          question: "Où est-ce que mes e-mails sont stockés ?",
          answer:
            "Les e-mails anonymisés sont stockés temporairement sur un serveur de l'Université de Heidelberg, protégé par un mot de passe. Seuls les mails entièrement anonymisés seront stockés à plus long terme.",
        },
        q11: {
          question: "Qui est-ce qui peut consulter mes e-mails ?",
          answer:
            "Les e-mails que vous nous envoyez sont protégés contre tout accès non autorisé. Grâce à l'anonymisation automatique, aucune donnée personnelle n'est reconnaissable. Après l'anonymisation, les e-mails sont stockés dans une base de données, utilisée à des fins de recherche. Les e-mails y sont analysés à l'aide de paramètres de recherche spécifiques – ceux-ci sont variables en fonction de la question de recherche choisie. L'accès aux e-mails anonymisés est strictement limité. Seules les personnes autorisées par la direction du projet peuvent analyser les e-mails. Les membres en faisant partie sont :",
          listItems: [
            "Les post-doctorant.e.s,",
            "Les doctorant.e.s,",
            "Les étudiant.e.s assistant.e.s sélectionné.e.s et collaborant au projet.",
          ],
          afterList:
            "Cela nous permet de vous garantir que vos données sont traitées exclusivement dans le cadre de ce projet de recherche et par des professionnel·le·s qualifié·e·s.",
        },
        q12: {
          question:
            "Comment et où les données sont-elles éventuellement publiées ?",
          answer1:
            "Les e-mails sont analysés scientifiquement par nos soins. Les résultats de recherche qui en découlent sont diffusés dans des publications spécialisées. Dans ces dernières, des exemples isolés, tirés du corpus des e-mails, sont publiés sous une forme anonymisée, afin d'illustrer des thèses scientifiques. Si vous souhaitez en savoir plus sur les résultats de nos recherches, vous pouvez vous abonner à",
          answer2: "ici.",
        ...
        q14: {
          ...
          answer:
            " Lors du don d'e-mails, il vous sera demandé de transférer les mails que vous souhaitez donner à une adresse de donateur. Veuillez ne pas transférer de pièce jointe trop volumineuse (max. 10 MB).",
        },
        q15: {
          question:
            "De quelles conditions techniques ai-je besoin pour donner mes e-mails ?",
          answer:
            "Vous devez simplement transférer vos e-mails à l'adresse mail indiquée lors du processus de don.",
        },
      },
    },
  },
...
type _Translatable<T> = {
  [K in keyof T]: T[K] extends string ? string : _Translatable<T[K]>;
};
